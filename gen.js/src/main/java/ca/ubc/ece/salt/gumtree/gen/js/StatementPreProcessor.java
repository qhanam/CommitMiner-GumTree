...
public abstract class StatementPreProcessor implements PreProcessor {
    ...
    /**
     * Processes a statement an returns a new statement to insert in its place.
     * 
     * @param node
    ...
    /**
     * Calls the abstract process method on each child statement and replaces the
     * statements with the new statements generated by the abstract process method.
     * 
     * @param node
     *            The node with child statements.
     */
    private void processStatements(AstRoot node) {

	/*
	 * Get the list of children. We can't directly iterate over the children of the
	 * node because we also need to operate on them.
	 */
	...
	for (AstNode statement : statements) {
		...
		node.replaceChild(statement, newStatement);
	}
